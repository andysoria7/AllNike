...
if(isset($_GET['borrar_id'])){
  $borrar_id= $_GET['borrar_id'];
    ...
    $sql='delete from categorias where cate_id='.$borrar_id;
               ...
               echo '
                 <tr>
                  ...
                  <button class="btn btn-outline-success my-2 my-sm-0"><i class="fa fa-save">Editar</i></button></a>
                   ...
                   <button onclick="Confirm_borrar('.$fila['cate_id'].')" class="btn btn-outline-danger my-2 my-sm-0"><i class="fa fa-save">
                   Borrar</i></button>
