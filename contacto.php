    ...
    <div class="container">
      <div class="content-center">
        ...
        <table>
            ...
            <tr>
                <td>
                  <input type="reset" class="btn btn-outline-danger my-2 my-sm-0" value="Borrar">
                </td>
                <td>
                     <input type="submit" name="enviar" value="Enviar" class="btn btn-outline-success my-2 my-sm-0"></td>
            </tr>
