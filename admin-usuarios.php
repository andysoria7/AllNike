  ...
  <section id="hero">
    <div class="container">
      ...
      <input class="form-control mr-sm-2" type="search" placeholder="Buscar" aria-label="Search">
        ...
        <td>
          <button class="btn btn-outline-success my-2 my-sm-0">Buscar</button></a>
        </td>

        <td> <a href="admin-agregar-usuarios.php">
          <button class="btn btn-outline-success my-2 my-sm-0"><i class="fa fa-save">Agregar</i></button></a>
        </a>
              ...
              echo '
                ...
                <td>';
                  ...
                  <td><a href="admin-editar-usuarios.php?usu_id='.$fila['usu_id'].'">
                     <button class="btn btn-outline-success my-2 my-sm-0"><i class="fa fa-save">Editar</i></button></a></a></td>
                  <td><a href="admin-borrar-usuarios.php?usu_id='.$fila['usu_id'].'">
                  <button class="btn btn-outline-danger my-2 my-sm-0"><i class="fa fa-save">Borrar</i></button></a></td></a></td>
                '  
                ;
            }
              ?>
