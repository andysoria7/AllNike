...
if(isset($_POST['editar'])){
    ...
    // Valido el nombre
     ...
     if($produ_nombre==''){
         ...
         header('location:admin-agregar-productos.php?produ_id='.$produ_id.'&resultado='.$mensaje);
         die();
    }
 ...
 <?php 
  ...
  <section id="hero">
    ...
    <?php 
        ...
        <form name="formu" method="post" action="admin-editar-productos.php?produ_id=<?php echo $fila['produ_id']; ?>">
            ...
            <tr>
              ...
              <tr>
                ...
                <tr>
                        ...
                        <td>
                     <input type="submit" class="btn btn-outline-success my-2 my-sm-0" value="Editar" name="editar"></td>
                    </tr>
    ...
    <footer>
            <address>Todos los derechos reservados para allnike</address>
        </footer>
