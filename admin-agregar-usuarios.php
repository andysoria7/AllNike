...
<body>
  ...
  <section id="hero">
    ...
    <form name="formu" method="post" action="admin-agregar-usuarios.php">
        <table>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="number" required name="usu_documento" id="usu_documento" min="0">
            ...
            <tr>
                <td>
                 ...
                 <td>   <!--Si pongo mismo name solo puedo seleccionar una casilla-->
                     <input type=radio name="usu_sexo" id="sexo" value="f">Femenino
                     <input type=radio name="usu_sexo" id="sexo" value="m">Masculino
                     <input type=radio name="usu_sexo" id="sexo" value="o" checked>Otro <!--checked elije una opcion por defecto y sirve para checkbox y radiobutton-->
                 </td>
            </tr>    
            <tr>
                <td>
