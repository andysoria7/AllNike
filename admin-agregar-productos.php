...
if(isset($_POST['agregar'])){
    ...
    // Valido el codigo
    if($produ_codigo==''){
         $mensaje='Error no ingreso  el codigo '; 
    ...
    // Valido el precio
     ...
     if($produ_precio==''){
         $mensaje='Error, no ingreso el precio '; 
         header('location:admin-agregar-productos.php?resultado='.$mensaje);
         die();
    }
    ...
    // Valido la descripcion
     ...
     if($produ_descripcion==''){
         $mensaje='Error, no ingreso la descripcion '; 
         header('location:admin-agregar-productos.php?resultado='.$mensaje);
         die();
    }
    ...
    if($produ_stock==''){
         $mensaje='Error, no ingreso la cantidad de stock '; 
         header('location:admin-agregar-productos.php?resultado='.$mensaje);
         die();
    }
  ...
  <section id="hero">
    <div class="container">
      <div class="content-center">
        ...
        <form name="formu" method="post" action="admin-agregar-productos.php"  enctype="multipart/form-data">
        <table>
        ...
        <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td>
                    <input type="text" required name="produ_codigo" id="codigo">
            ...
            <tr>
                ...
                <td>
                    <input type="number" required name="produ_precio" id="precio" min="0">
                    <!--requid hace un campo obligatorio-->
                </td>
              ...
              <tr>
                  ...
                  <td>
                      <input type="number" required name="produ_stock" id="hijos" min="0">
                      <!--requid hace un campo obligatorio-->
                  </td>
              </tr>
                ...
                <tr>
                    <td>
                     ...
                     <td>   
                         <textarea name="produ_descripcion" id="asunto" cols="30" rows="3">
                ...
                <tr>
                     ...
                     <td>
                        ...
                        <input type="button" class="btn btn-outline-danger my-2 my-sm-0" value="Cancelar"></a>
                        </td>

                     <td>
                     <input type="submit" name="agregar" value="Agregar" class="btn btn-outline-success my-2 my-sm-0"></td>
