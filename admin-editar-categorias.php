  ...
  <section id="hero">
    <div class="container">
      <div class="content-center">
        ...
        <form name="formu" method="post" action="admin-editar-categorias.php"  enctype="multipart/form-data">
        <input type="hidden" id="cate_id" name="cate_id" value="<?php echo $cate_id; ?>">
        <table>
            ...
            <tr>
                ...
                <tr>
                     ...
                     <td>
                     <input type="submit" name="editar" value="Editar" class="btn btn-outline-success my-2 my-sm-0"></td>
